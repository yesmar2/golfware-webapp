...
const LeftDrawer = () => (
    <Container>
        <AppName>
            <Link to="/">
                <Heading>Golfware</Heading>
            </Link>
        </AppName>
        <Menu>
            <MenuItem href="/schedule" icon={<FaCalendar />} text="Schedule" />
            <MenuItem
                href="/scoreentry/1"
                icon={<FaGolfBall />}
                text="Score Entry"
            />
            <MenuItem href="/teams" icon={<FaUsers />} text="Teams" />
            <MenuItem href="/players" icon={<FaUser />} text="Players" />
        </Menu>
    </Container>
);
